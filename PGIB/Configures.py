...
class TrainParser():
    def __init__(self):
        ...
        self.joint_optimizer_lrs = {'features': 1e-5,
                       'add_on_layers': 3e-4,
                       'prototype_vectors': 3e-4}      
        self.global_epochs = 300 
        self.warm_epochs = 10                      
        self.proj_epochs = 50 
        self.sampling_epochs = 50                     
